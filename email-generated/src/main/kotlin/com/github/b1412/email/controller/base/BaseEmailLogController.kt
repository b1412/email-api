...
@PutMapping("{id}")
override fun updateOne(@PathVariable id: Long, @Validated @RequestBody input: EmailLog, request: HttpServletRequest): ResponseEntity<*> {
super.updateOne(id, input, request)
return ResponseEntity.noContent().build<EmailLog>()
}
